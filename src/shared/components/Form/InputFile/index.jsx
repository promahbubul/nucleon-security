  ...
  return (
    ...
    >
      {file ? (
        ...
        <div className="flex flex-row gap-2 items-center  inset-y-0 inset-x-0 col-span-9  justify-center   cursor-pointer absolute  ">
          <FaFile className="text-2xl font-extrabold cursor-pointer text-slate-400 dark:text-navy-100" />
          <span className="dark:text-navy-100 cursor-pointer  text-slate-400">
            File
          </span>
        </div>
      )}
