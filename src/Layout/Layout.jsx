          ...
          <div className="relative w-max group hover:bg-slate-200 dark:hover:bg-navy-600 px-2 py-1 rounded-md">
            ...
            {showDropDownMenu && (
              ...
              >
                ...
                <NavLink
                  className={
                    "cursor-pointer hover:bg-slate-100 text-gray-500 duration-300 p-2 dark:text-navy-100 dark:hover:bg-navy-700 rounded-md flex flex-row items-center gap-1"
                  }
                  to={"/training"}
                >
                  <img
