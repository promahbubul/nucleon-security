        ...
        <div className="flex flex-row gap-1  mt-5 items-start">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="p-2 border w-max cursor-pointer border-info hover:shadow-md rounded-full">
              <FaPlus className="text-sm hover:text-info duration-300 " />
            </div>
          </div>
          {/* right box */}
          <div className="border w-full p-2 flex flex-col gap-2">
            ...
            <div className="flex flex-row">
              <h4 className="w-4/12 text-base font-bold text-navy-700">Type</h4>
            ...
            <div className="flex flex-row pb-5 border-b border-b-slate-300">
              <h4 className="w-4/12 flex flex-row items-center gap-1     text-base font-bold text-navy-700">
                Notifications
            ...
            <div className="flex flex-row items-center gap-2">
              ...
              <p className="text-base font-normal text-navy-700">
